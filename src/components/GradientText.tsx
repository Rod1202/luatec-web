...
export default function GradientText({
    ...
    return (
        <motion.div
            className={`relative inline-block transition-shadow duration-500 ${showBorder ? 'flex max-w-fit flex-row items-center justify-center rounded-[1.25rem] font-medium backdrop-blur overflow-hidden cursor-pointer py-1 px-2' : ''} ${className}`}
